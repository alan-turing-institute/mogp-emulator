...
def test_kernel_calc_drdx():
    ...
    deriv_fd = np.zeros((2, 2, 2))
    deriv_fd[0] = (k.calc_r(x + np.array([[dx, 0.], [dx, 0.]]), y, params) - k.calc_r(x - np.array([[dx, 0.], [dx, 0.]]), y, params))/dx/2.
    deriv_fd[1] = (k.calc_r(x + np.array([[0., dx], [0., dx]]), y, params) - k.calc_r(x - np.array([[0., dx], [0., dx]]), y, params))/dx/2.
...
def test_matern_5_2_inputderiv():
    ...
    deriv[0] = -5./3.*r*(1.+np.sqrt(5.)*r)*np.exp(-np.sqrt(5.)*r)*np.array([[-1., -1.], [0., -1.]])
    deriv_fd = np.zeros((1, 2, 2))
    deriv_fd[0] = (k.kernel_f(x + dx, y, params)-k.kernel_f(x - dx, y, params))/dx/2.

    assert_allclose(k.kernel_inputderiv(x, y, params), deriv)
    assert_allclose(k.kernel_inputderiv(x, y, params), deriv_fd, rtol = 1.e-5, atol = 1.e-8)
    ...
    deriv[0] = -5./3.*(1.+np.sqrt(5.)*r)*np.exp(-np.sqrt(5.)*r)*np.array([[-1., -2.], [0., -1.]])
    deriv[1] = -5./3.*(1.+np.sqrt(5.)*r)*np.exp(-np.sqrt(5.)*r)*np.array([[-2., 1.], [-1., 2.]])
    deriv_fd = np.zeros((2, 2, 2))
    deriv_fd[0] = (k.kernel_f(x + np.array([[dx, 0.], [dx, 0.]]), y, params)-k.kernel_f(x - np.array([[dx, 0.], [dx, 0.]]), y, params))/dx/2.
    deriv_fd[1] = (k.kernel_f(x + np.array([[0., dx], [0., dx]]), y, params)-k.kernel_f(x - np.array([[0., dx], [0., dx]]), y, params))/dx/2.
    ...
    deriv[0] = -np.exp(2.)*np.exp(2.)*5./3.*(1.+np.sqrt(5.)*r)*np.exp(-np.sqrt(5.)*r)*np.array([[-1., -2.], [0., -1.]])
    deriv[1] = -np.exp(2.)*np.exp(4.)*5./3.*(1.+np.sqrt(5.)*r)*np.exp(-np.sqrt(5.)*r)*np.exp(-0.5*r**2)*np.array([[-2., 1.], [-1., 2.]])
    deriv_fd = np.zeros((2, 2, 2))
    deriv_fd[0] = (k.kernel_f(x + np.array([[dx, 0.], [dx, 0.]]), y, params)-k.kernel_f(x - np.array([[dx, 0.], [dx, 0.]]), y, params))/dx/2.
    deriv_fd[1] = (k.kernel_f(x + np.array([[0., dx], [0., dx]]), y, params)-k.kernel_f(x - np.array([[0., dx], [0., dx]]), y, params))/dx/2.
